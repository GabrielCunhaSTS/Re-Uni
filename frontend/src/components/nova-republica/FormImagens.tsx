...
export function FormImagens({ 
    ...
    function handleDrop(tipoAlvo: 'existente' | 'novo', indexAlvo: number) {
        ...
        if (draggedIndex.tipo !== tipoAlvo) return; // Não mistura existentes com novos arquivos no arrasto
    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                ...
                <p className="text-xs text-slate-400 mt-1.5">Arraste os cards para alterar a ordem das fotos. A primeira foto será a capa do imóvel.</p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
                ...
                {imagensExistentes.map((img, index) => (
                    ...
                    >
                        ...
                        {/* Indicador de Capa (Primeira foto) */}
                        {index === 0 && (
