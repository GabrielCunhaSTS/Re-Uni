...
export default function DashboardAnunciantePage() {
    ...
    const [abaAtiva, setAbaAtiva] = useState<"republicas" | "solicitacoes" | "manutencao">("republicas");
            ...
            <main className="max-w-6xl mx-auto px-6 py-8 space-y-8">
                ...
                <div className="flex border-b border-slate-200 gap-8">
                    ...
                    <button
                        ...
                        className={`pb-4 text-sm font-bold flex items-center gap-2 border-b-2 transition-all ${abaAtiva === "manutencao" ? "border-blue-900 text-blue-950" : "border-transparent text-slate-400 hover:text-slate-600"}`}
                    >
